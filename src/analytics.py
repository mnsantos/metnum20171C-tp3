...
def cross_validation_paises_promedio_global(anios_train, anios_test, pais_objetivo, c):
	#aplicar distancia y bla
	A = ciudades_de_pais(pais_objetivo, anios_train, c)
	#print A
	b = temperaturas_promedio_anios([pais_objetivo], anios_train, c)
	#print len(b)
	coeficientes = cml(A, b)
